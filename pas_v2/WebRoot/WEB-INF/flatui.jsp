...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<%=basePath %>/FlatUI/img/favicon.ico">
  ...
  <body>
    <div class="container">
      ...
      <div class="demo-illustrations">
        <div class="demo-content">
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/toilet-paper.svg" alt="Toilet-Paper"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/gift-box.svg" alt="Gift-Box"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/pencils.svg" alt="Pensils"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/clipboard.svg" alt="Clipboard"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/retina.svg" alt="Retina"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/compas.svg" alt="Compas"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/map.svg" alt="Map"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/chat.svg" alt="Chat"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/mail.svg" alt="Mail"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/book.svg" alt="Book"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/calendar.svg" alt="Calendar"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/paper-bag.svg" alt="Pocket"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/clocks.svg" alt="Watches"></div>
          <div><img src="<%=basePath %>/FlatUI/img/icons/svg/loop.svg" alt="Infinity-Loop"></div>
        </div>
      </div>
      ...
      <div class="row demo-samples">
        ...
        <div class="col-xs-8">
          <video class="video-js" preload="auto" poster="<%=basePath %>/FlatUI/docs/assets/img/video/poster.jpg" data-setup="{}">
      ...
      <div class="row demo-tiles">
        <div class="col-xs-3">
          <div class="tile">
            <img src="<%=basePath %>/FlatUI/img/icons/svg/compas.svg" alt="Compas" class="tile-image big-illustration">
        ...
        <div class="col-xs-3">
          <div class="tile">
            <img src="<%=basePath %>/FlatUI/img/icons/svg/loop.svg" alt="Infinity-Loop" class="tile-image">
        ...
        <div class="col-xs-3">
          <div class="tile">
            <img src="<%=basePath %>/FlatUI/img/icons/svg/pencils.svg" alt="Pensils" class="tile-image">
        ...
        <div class="col-xs-3">
          <div class="tile tile-hot">
            <img src="<%=basePath %>/FlatUI/img/icons/svg/ribbon.svg" alt="ribbon" class="tile-hot-ribbon">
            <img src="<%=basePath %>/FlatUI/img/icons/svg/chat.svg" alt="Chat" class="tile-image">
        ...
        <div class="col-xs-9">
          <div class="demo-browser">
            ...
            <div class="demo-browser-content">
              <img src="<%=basePath %>/FlatUI/docs/assets/img/demo/browser-pic-1.jpg" alt="" />
              <img src="<%=basePath %>/FlatUI/docs/assets/img/demo/browser-pic-2.jpg" alt="" />
              <img src="<%=basePath %>/FlatUI/docs/assets/img/demo/browser-pic-3.jpg" alt="" />
              <img src="<%=basePath %>/FlatUI/docs/assets/img/demo/browser-pic-4.jpg" alt="" />
              <img src="<%=basePath %>/FlatUI/docs/assets/img/demo/browser-pic-5.jpg" alt="" />
              <img src="<%=basePath %>/FlatUI/docs/assets/img/demo/browser-pic-6.jpg" alt="" />
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xs-7">
            ...
            <a class="footer-brand" href="http://designmodo.com" target="_blank">
              <img src="<%=basePath %>/FlatUI/docs/assets/img/footer/logo.png" alt="Designmodo.com" />
            </a>
          </div> <!-- /col-xs-7 -->
    ...
    <script src="<%=basePath %>/FlatUI/dist/js/vendor/jquery.min.js"></script>
    <script src="<%=basePath %>/FlatUI/dist/js/vendor/video.js"></script>
    <script src="<%=basePath %>/FlatUI/dist/js/flat-ui.min.js"></script>
    <script src="<%=basePath %>/FlatUI/docs/assets/js/application.js"></script>

    <script>
      videojs.options.flash.swf = "<%=basePath %>/FlatUIdist/js/vendors/video-js.swf"
    </script>
  </body>
</html>
