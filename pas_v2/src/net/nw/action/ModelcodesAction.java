...
public class ModelcodesAction extends ActionSupport implements RequestAware,SessionAware,ModelDriven<Modelcodes>,ServletResponseAware,ServletRequestAware{
	/**
	 * 
	 */
	...
	//显示所选project所有Model问题点数
	public String login_select_project()
	{
		
			DefactAllDAO dad=new DefactAllDAO();
			List<Integer> listTotal= dad.getAll_type_select_project(request11.getParameter("projectname"));
			...
			//request1.setAttribute("projectname", request11.getParameter("projectname"));
			...
			List<String> listTotal3= dad.getDailyData(mc);
	...
	public String login_select()
	{
		...
		session.put("projectname_session", pn);
		if(mc.getCodeid()==0)
		{		
				
			//session.put("modelname_session",request1.getParameter("modelname")); 2016-11-25 wuliying delete			
			...
			//System.out.println("前前前前前前前前前前前前前");
			for(int i=21;i<=60;i++){
				request.put("Day"+i, listTotal3.get(20+i));
			}
			
			for(int i=21;i<=60;i++){
				request.put("ResolveDay"+i, listTotal3.get(60+i));
			}
			...
			request.put("modelname",utd.idTOName_model(mc.getCodeid()));
			System.out.println("else******************************************************************************");		
			DefactAllDAO dad=new DefactAllDAO();
			List<Integer> listTotal2=dad.getAll_select(mc);
			if(mc.getCodeid()==0){
				listTotal2= dad.getAll_select_projectname(request11.getParameter("projectname"));
			}
			
			System.out.println("Projectname$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"+request11.getParameter("projectname"));
			...
			if(mc.getCodeid()==0){
				listTotal21= dad.getAll_type_select_project(request11.getParameter("projectname"));
			}
			...
			List<String> listTotal3= dad.getDailyData(mc);
			if(mc.getCodeid()==0){
				listTotal3= dad.getDailyData(request11.getParameter("projectname"));
			}
			...
			request.put("Day19", listTotal3.get(34));
			request.put("Day20", listTotal3.get(35));
			session.put("Day15_session", listTotal3.get(0));
			...
			if(mc.getCodeid()!=0){
				request.put("msg_codename", utd.idTOName_model(mc.getCodeid()));
				System.out.println("code id不等于0");
			}
			else if(mc.getCodeid()==0){ 
				request.put("msg_codename", "All");
				System.out.println("code id等于0");
			}
				
			Map<String,Integer> mapBlock= dad.getAllBlock(mc);
			if(mc.getCodeid()==0){ 
				mapBlock= dad.getAllBlock(request11.getParameter("projectname"));
			}
			List<String> listBlock1=new ArrayList<String>();
			List<String> listBlock2=new ArrayList<String>();
			...
			request.put("BlockItem9", listBlock1.get(32).replace("Closed", ""));
			request.put("BlockItem10", listBlock1.get(36).replace("Closed", ""));
			request.put("BlockItem11", listBlock1.get(40).replace("Closed", ""));
			request.put("BlockItem12", listBlock1.get(44).replace("Closed", ""));
			request.put("BlockItem13", listBlock1.get(48).replace("Closed", ""));
			request.put("BlockItem14", listBlock1.get(52).replace("Closed", ""));
			request.put("BlockItem15", listBlock1.get(56).replace("Closed", ""));
			request.put("BlockItem16", listBlock1.get(60).replace("Closed", ""));
			request.put("BlockItem17", listBlock1.get(64).replace("Closed", ""));
			request.put("BlockItem18", listBlock1.get(68).replace("Closed", ""));
			request.put("BlockItem19", listBlock1.get(72).replace("Closed", ""));
			request.put("BlockItem20", listBlock1.get(76).replace("Closed", ""));
			request.put("BlockItem21", listBlock1.get(80).replace("Closed", ""));
			request.put("BlockItem22", listBlock1.get(84).replace("Closed", ""));
			request.put("BlockItem23", listBlock1.get(88).replace("Closed", ""));
			request.put("BlockItem24", listBlock1.get(92).replace("Closed", ""));
			request.put("BlockItem25", listBlock1.get(96).replace("Closed", ""));
			request.put("BlockItem26", listBlock1.get(100).replace("Closed", ""));
			request.put("BlockItem27", listBlock1.get(104).replace("Closed", ""));
			request.put("BlockItem28", listBlock1.get(108).replace("Closed", ""));
			request.put("BlockItem29", listBlock1.get(112).replace("Closed", ""));
			request.put("BlockItem30", listBlock1.get(116).replace("Closed", ""));
			request.put("BlockItem31", listBlock1.get(120).replace("Closed", ""));
			request.put("BlockItem32", listBlock1.get(124).replace("Closed", ""));
			request.put("BlockItem33", listBlock1.get(128).replace("Closed", ""));
			...
			request.put("BlockRejected10", listBlock2.get(38));
			request.put("BlockResolved10", listBlock2.get(39));
			request.put("BlockClose11", listBlock2.get(40));
			request.put("BlockPending11", listBlock2.get(41));
			request.put("BlockRejected11", listBlock2.get(42));
			request.put("BlockResolved11", listBlock2.get(43));
			request.put("BlockClose12", listBlock2.get(44));
			request.put("BlockPending12", listBlock2.get(45));
			request.put("BlockRejected12", listBlock2.get(46));
			request.put("BlockResolved12", listBlock2.get(47));
			request.put("BlockClose13", listBlock2.get(48));
			request.put("BlockPending13", listBlock2.get(49));
			request.put("BlockRejected13", listBlock2.get(50));
			request.put("BlockResolved13", listBlock2.get(51));
			request.put("BlockClose14", listBlock2.get(52));
			request.put("BlockPending14", listBlock2.get(53));
			request.put("BlockRejected14", listBlock2.get(54));
			request.put("BlockResolved14", listBlock2.get(55));
			request.put("BlockClose15", listBlock2.get(56));
			request.put("BlockPending15", listBlock2.get(57));
			request.put("BlockRejected15", listBlock2.get(58));
			request.put("BlockResolved15", listBlock2.get(59));
			request.put("BlockClose16", listBlock2.get(60));
			request.put("BlockPending16", listBlock2.get(61));
			request.put("BlockRejected16", listBlock2.get(62));
			request.put("BlockResolved16", listBlock2.get(63));
			request.put("BlockClose17", listBlock2.get(64));
			request.put("BlockPending17", listBlock2.get(65));
			request.put("BlockRejected17", listBlock2.get(66));
			request.put("BlockResolved17", listBlock2.get(67));
			request.put("BlockClose18", listBlock2.get(68));
			request.put("BlockPending18", listBlock2.get(69));
			request.put("BlockRejected18", listBlock2.get(70));
			request.put("BlockResolved18", listBlock2.get(71));
			request.put("BlockClose19", listBlock2.get(72));
			request.put("BlockPending19", listBlock2.get(73));
			request.put("BlockRejected19", listBlock2.get(74));
			request.put("BlockResolved19", listBlock2.get(75));
			request.put("BlockClose20", listBlock2.get(76));
			request.put("BlockPending20", listBlock2.get(77));
			request.put("BlockRejected20", listBlock2.get(78));
			request.put("BlockResolved20", listBlock2.get(79));
			request.put("BlockClose21", listBlock2.get(80));
			request.put("BlockPending21", listBlock2.get(81));
			request.put("BlockRejected21", listBlock2.get(82));
			request.put("BlockResolved21", listBlock2.get(83));
			request.put("BlockClose22", listBlock2.get(84));
			request.put("BlockPending22", listBlock2.get(85));
			request.put("BlockRejected22", listBlock2.get(86));
			request.put("BlockResolved22", listBlock2.get(87));
			request.put("BlockClose23", listBlock2.get(88));
			request.put("BlockPending23", listBlock2.get(89));
			request.put("BlockRejected23", listBlock2.get(90));
			request.put("BlockResolved23", listBlock2.get(91));
			request.put("BlockClose24", listBlock2.get(92));
			request.put("BlockPending24", listBlock2.get(93));
			request.put("BlockRejected24", listBlock2.get(94));
			request.put("BlockResolved24", listBlock2.get(95));
			request.put("BlockClose25", listBlock2.get(96));
			request.put("BlockPending25", listBlock2.get(97));
			request.put("BlockRejected25", listBlock2.get(98));
			request.put("BlockResolved25", listBlock2.get(99));
			request.put("BlockClose26", listBlock2.get(100));
			request.put("BlockPending26", listBlock2.get(101));
			request.put("BlockRejected26", listBlock2.get(102));
			request.put("BlockResolved26", listBlock2.get(103));
			request.put("BlockClose27", listBlock2.get(104));
			request.put("BlockPending27", listBlock2.get(105));
			request.put("BlockRejected27", listBlock2.get(106));
			request.put("BlockResolved27", listBlock2.get(107));
			request.put("BlockClose28", listBlock2.get(108));
			request.put("BlockPending28", listBlock2.get(109));
			request.put("BlockRejected28", listBlock2.get(110));
			request.put("BlockResolved28", listBlock2.get(111));
			request.put("BlockClose29", listBlock2.get(112));
			request.put("BlockPending29", listBlock2.get(113));
			request.put("BlockRejected29", listBlock2.get(114));
			request.put("BlockResolved29", listBlock2.get(115));
			request.put("BlockClose30", listBlock2.get(116));
			request.put("BlockPending30", listBlock2.get(117));
			request.put("BlockRejected30", listBlock2.get(118));
			request.put("BlockResolved30", listBlock2.get(119));
			request.put("BlockClose31", listBlock2.get(120));
			request.put("BlockPending31", listBlock2.get(121));
			request.put("BlockRejected31", listBlock2.get(122));
			request.put("BlockResolved31", listBlock2.get(123));
			request.put("BlockClose32", listBlock2.get(124));
			request.put("BlockPending32", listBlock2.get(125));
			request.put("BlockRejected32", listBlock2.get(126));
			request.put("BlockResolved32", listBlock2.get(127));
			request.put("BlockClose33", listBlock2.get(128));
			request.put("BlockPending33", listBlock2.get(129));
			request.put("BlockRejected33", listBlock2.get(130));
			request.put("BlockResolved33", listBlock2.get(131));
			*/
			Map<String,Integer> map= dad.getAllComponent(mc);
			if(mc.getCodeid()==0){
				map= dad.getAllComponent(request1.getParameter("projectname"));
			}
			...
			Iterator<String> iter=keys.iterator();		
			while(iter.hasNext()){
				listComp.add(iter.next());
			}
		
			Collection<Integer> values=map.values();
			Iterator<Integer> iter1=values.iterator();
			while(iter1.hasNext()){
				listCount.add(iter1.next()+"");
			}		
		
			/*
			request.put("CompItem1", listComp.get(0).replace("Closed", ""));
			request.put("CompItem2", listComp.get(4).replace("Closed", ""));
			request.put("CompItem3", listComp.get(8).replace("Closed", ""));
			request.put("CompItem4", listComp.get(12).replace("Closed", ""));
			request.put("CompItem5", listComp.get(16).replace("Closed", ""));
			request.put("CompItem6", listComp.get(20).replace("Closed", ""));	
			request.put("CompItem7", listComp.get(24).replace("Closed", ""));		
			request.put("CompItem8", listComp.get(28).replace("Closed", ""));		
			request.put("CompItem9", listComp.get(32).replace("Closed", ""));		
			request.put("CompItem10", listComp.get(36).replace("Closed", ""));		
			
			//request.put("CompClose1", listCount.get(0));
			request.put("CompClose1", listCount.get(0));
			request.put("CompPending1", listCount.get(1));
			request.put("CompRejected1", listCount.get(2));
			request.put("CompResolved1", listCount.get(3));
			request.put("CompClose2", listCount.get(4));
			request.put("CompPending2", listCount.get(5));
			request.put("CompRejected2", listCount.get(6));
			request.put("CompResolved2", listCount.get(7));
			request.put("CompClose3", listCount.get(8));
			request.put("CompPending3", listCount.get(9));
			request.put("CompRejected3", listCount.get(10));
			request.put("CompResolved3", listCount.get(11));
			
			request.put("CompClose4", listCount.get(12));
			request.put("CompPending4", listCount.get(13));
			request.put("CompRejected4", listCount.get(14));
			request.put("CompResolved4", listCount.get(15));
			request.put("CompClose5", listCount.get(16));
			request.put("CompPending5", listCount.get(17));
			request.put("CompRejected5", listCount.get(18));
			request.put("CompResolved5", listCount.get(19));
			request.put("CompClose6", listCount.get(20));
			request.put("CompPending6", listCount.get(21));
			request.put("CompRejected6", listCount.get(22));
			request.put("CompResolved6", listCount.get(23));
			request.put("CompClose7", listCount.get(24));
			request.put("CompPending7", listCount.get(25));
			request.put("CompRejected7", listCount.get(26));
			request.put("CompResolved7", listCount.get(27));
			request.put("CompClose8", listCount.get(28));
			request.put("CompPending8", listCount.get(29));
			request.put("CompRejected8", listCount.get(30));
			request.put("CompResolved8", listCount.get(31));
			request.put("CompClose9", listCount.get(32));
			request.put("CompPending9", listCount.get(33));
			request.put("CompRejected9", listCount.get(34));
			request.put("CompResolved9", listCount.get(35));
			request.put("CompClose10", listCount.get(36));
			request.put("CompPending10", listCount.get(37));
			request.put("CompRejected10", listCount.get(38));
			request.put("CompResolved10", listCount.get(39));
			*/
			if(("0".equals(listCount.get(0)))&&("0".equals(listCount.get(1)))&&("0".equals(listCount.get(2)))&&("0".equals(listCount.get(3)))){
				request.put("CompItem1", " ");
				request.put("CompClose1", " ");
				request.put("CompPending1", " ");
				request.put("CompRejected1", " ");
				...
				if(listComp.get(0).contains("NonSmartClosed"))
					request.put("CompItem1", listComp.get(0).replace("NonSmartClosed", ""));
				else 
					request.put("CompItem1", listComp.get(0).replace("Closed", ""));
				
				if("0".equals(listCount.get(0)))
					request.put("CompClose1", " ");
				else
					request.put("CompClose1", listCount.get(0));
				if("0".equals(listCount.get(1)))
					request.put("CompPending1", " ");
				else
				request.put("CompPending1", listCount.get(1));
				if("0".equals(listCount.get(2)))
					request.put("CompRejected1", " ");
				else
					request.put("CompRejected1", listCount.get(2));
				if("0".equals(listCount.get(3)))
					request.put("CompResolved1", " ");
				else
					request.put("CompResolved1", listCount.get(3));
			...
			if(("0".equals(listCount.get(4)))&&("0".equals(listCount.get(5)))&&("0".equals(listCount.get(6)))&&("0".equals(listCount.get(7)))){
				request.put("CompItem2", " ");
				request.put("CompClose2", " ");
				request.put("CompPending2", " ");
				request.put("CompRejected2", " ");
				...
				if(listComp.get(4).contains("NonSmartClosed"))
					request.put("CompItem2", listComp.get(4).replace("NonSmartClosed", ""));
				else 
					request.put("CompItem2", listComp.get(4).replace("Closed", ""));
				
				if("0".equals(listCount.get(4)))
					request.put("CompClose2", " ");
				else
					request.put("CompClose2", listCount.get(4));
				
				if("0".equals(listCount.get(5)))
					request.put("CompPending2", " ");
				else
					request.put("CompPending2", listCount.get(5));
				
				if("0".equals(listCount.get(6)))
					request.put("CompRejected2", " ");
				else
					request.put("CompRejected2", listCount.get(6));
				 
				if("0".equals(listCount.get(7)))
					request.put("CompResolved2", " ");
				else
					request.put("CompResolved2", listCount.get(7));	
			...
			if(("0".equals(listCount.get(8)))&&("0".equals(listCount.get(9)))&&("0".equals(listCount.get(10)))&&("0".equals(listCount.get(11)))){
				request.put("CompItem3", " ");
				request.put("CompClose3", " ");
				request.put("CompPending3", " ");
				request.put("CompRejected3", " ");
				...
				if(listComp.get(8).contains("NonSmartClosed"))
					request.put("CompItem3", listComp.get(8).replace("NonSmartClosed", ""));
				else 
					request.put("CompItem3", listComp.get(8).replace("Closed", ""));
				
				if("0".equals(listCount.get(8)))
					request.put("CompClose3", " ");
				else
					request.put("CompClose3", listCount.get(8));
				
				if("0".equals(listCount.get(9)))
					request.put("CompPending3", " ");
				else
					request.put("CompPending3", listCount.get(9));
				
				if("0".equals(listCount.get(10)))
					request.put("CompRejected3", " ");
				else
					request.put("CompRejected3", listCount.get(10));
				 
				if("0".equals(listCount.get(11)))
					request.put("CompResolved3", " ");
				else
					request.put("CompResolved3", listCount.get(11));
			}
			
			if(("0".equals(listCount.get(12)))&&("0".equals(listCount.get(13)))&&("0".equals(listCount.get(14)))&&("0".equals(listCount.get(15)))){
				request.put("CompItem4", " ");
				request.put("CompClose4", " ");
				request.put("CompPending4", " ");
				request.put("CompRejected4", " ");
				...
				if(listComp.get(12).contains("NonSmartClosed"))
					request.put("CompItem4", listComp.get(12).replace("NonSmartClosed", ""));
				else 
					request.put("CompItem4", listComp.get(12).replace("Closed", ""));
				
				if("0".equals(listCount.get(12)))
					request.put("CompClose4", " ");
				else
					request.put("CompClose4", listCount.get(12));
				
				if("0".equals(listCount.get(13)))
					request.put("CompPending4", " ");
				else
					request.put("CompPending4", listCount.get(13));
				
				if("0".equals(listCount.get(14)))
					request.put("CompRejected4", " ");
				else
					request.put("CompRejected4", listCount.get(14));
				 
				if("0".equals(listCount.get(15)))
					request.put("CompResolved4", " ");
				else
					request.put("CompResolved4", listCount.get(15));
			}
			...
			if(("0".equals(listCount.get(16)))&&("0".equals(listCount.get(17)))&&("0".equals(listCount.get(18)))&&("0".equals(listCount.get(19)))){
				request.put("CompItem5", " ");
				request.put("CompClose5", " ");
				request.put("CompPending5", " ");
				request.put("CompRejected5", " ");
				...
				if(listComp.get(16).contains("NonSmartClosed"))
					request.put("CompItem5", listComp.get(16).replace("NonSmartClosed", ""));
				else 
					request.put("CompItem5", listComp.get(16).replace("Closed", ""));
				
				if("0".equals(listCount.get(16)))
					request.put("CompClose5", " ");
				else
					request.put("CompClose5", listCount.get(16));
				
				if("0".equals(listCount.get(17)))
					request.put("CompPending5", " ");
				else
					request.put("CompPending5", listCount.get(17));
				
				if("0".equals(listCount.get(18)))
					request.put("CompRejected5", " ");
				else
					request.put("CompRejected5", listCount.get(18));
				 
				if("0".equals(listCount.get(19)))
					request.put("CompResolved5", " ");
				else
					request.put("CompResolved5", listCount.get(19));
			}
			
			if(("0".equals(listCount.get(20)))&&("0".equals(listCount.get(21)))&&("0".equals(listCount.get(22)))&&("0".equals(listCount.get(23)))){
				request.put("CompItem6", " ");
				request.put("CompClose6", " ");
				request.put("CompPending6", " ");
				request.put("CompRejected6", " ");
				...
				if(listComp.get(20).contains("NonSmartClosed"))
					request.put("CompItem6", listComp.get(20).replace("NonSmartClosed", ""));
				else 
					request.put("CompItem6", listComp.get(20).replace("Closed", ""));
				
				if("0".equals(listCount.get(20)))
					request.put("CompClose6", " ");
				else
					request.put("CompClose6", listCount.get(20));
				
				if("0".equals(listCount.get(21)))
					request.put("CompPending6", " ");
				else
					request.put("CompPending6", listCount.get(21));
				
				if("0".equals(listCount.get(22)))
					request.put("CompRejected6", " ");
				else
					request.put("CompRejected6", listCount.get(22));
				 
				if("0".equals(listCount.get(23)))
					request.put("CompResolved6", " ");
				else
					request.put("CompResolved6", listCount.get(23));
			}
			
			if(("0".equals(listCount.get(24)))&&("0".equals(listCount.get(25)))&&("0".equals(listCount.get(26)))&&("0".equals(listCount.get(27)))){
				request.put("CompItem7", " ");
				request.put("CompClose7", " ");
				request.put("CompPending7", " ");
				request.put("CompRejected7", " ");
				...
				if(listComp.get(24).contains("NonSmartClosed"))
					request.put("CompItem7", listComp.get(24).replace("NonSmartClosed", ""));
				else 
					request.put("CompItem7", listComp.get(24).replace("Closed", ""));
				
				if("0".equals(listCount.get(24)))
					request.put("CompClose7", " ");
				else
					request.put("CompClose7", listCount.get(24));
				
				if("0".equals(listCount.get(25)))
					request.put("CompPending7", " ");
				else
					request.put("CompPending7", listCount.get(25));
				
				if("0".equals(listCount.get(26)))
					request.put("CompRejected7", " ");
				else
					request.put("CompRejected7", listCount.get(26));
				 
				if("0".equals(listCount.get(27)))
					request.put("CompResolved7", " ");
				else
					request.put("CompResolved7", listCount.get(27));
			}
			...
			if(("0".equals(listCount.get(28)))&&("0".equals(listCount.get(29)))&&("0".equals(listCount.get(30)))&&("0".equals(listCount.get(31)))){
				request.put("CompItem8", " ");
				request.put("CompClose8", " ");
				request.put("CompPending8", " ");
				request.put("CompRejected8", " ");
				...
				if(listComp.get(28).contains("NonSmartClosed"))
					request.put("CompItem8", listComp.get(28).replace("NonSmartClosed", ""));
				else 
					request.put("CompItem8", listComp.get(28).replace("Closed", ""));
				
				if("0".equals(listCount.get(28)))
					request.put("CompClose8", " ");
				else
					request.put("CompClose8", listCount.get(28));
				
				if("0".equals(listCount.get(29)))
					request.put("CompPending8", " ");
				else
					request.put("CompPending8", listCount.get(29));
				
				if("0".equals(listCount.get(30)))
					request.put("CompRejected8", " ");
				else
					request.put("CompRejected8", listCount.get(30));
				 
				if("0".equals(listCount.get(31)))
					request.put("CompResolved8", " ");
				else
					request.put("CompResolved8", listCount.get(31));
			}
			
			if(("0".equals(listCount.get(32)))&&("0".equals(listCount.get(33)))&&("0".equals(listCount.get(34)))&&("0".equals(listCount.get(35)))){
				request.put("CompItem9", " ");
				request.put("CompClose9", " ");
				request.put("CompPending9", " ");
				request.put("CompRejected9", " ");
				...
				if(listComp.get(32).contains("NonSmartClosed"))
					request.put("CompItem9", listComp.get(32).replace("NonSmartClosed", ""));
				else 
					request.put("CompItem9", listComp.get(32).replace("Closed", ""));
				
				if("0".equals(listCount.get(32)))
					request.put("CompClose9", " ");
				else
					request.put("CompClose9", listCount.get(32));
				
				if("0".equals(listCount.get(33)))
					request.put("CompPending9", " ");
				else
					request.put("CompPending9", listCount.get(33));
				
				if("0".equals(listCount.get(34)))
					request.put("CompRejected9", " ");
				else
					request.put("CompRejected9", listCount.get(34));
				 
				if("0".equals(listCount.get(35)))
					request.put("CompResolved9", " ");
				else
					request.put("CompResolved9", listCount.get(35));
			...
			if(("0".equals(listCount.get(36)))&&("0".equals(listCount.get(37)))&&("0".equals(listCount.get(38)))&&("0".equals(listCount.get(39)))){
				request.put("CompItem10", " ");
				request.put("CompClose10", " ");
				request.put("CompPending10", " ");
				request.put("CompRejected10", " ");
				...
				if(listComp.get(36).contains("NonSmartClosed"))
					request.put("CompItem10", listComp.get(36).replace("NonSmartClosed", ""));
				else 
					request.put("CompItem10", listComp.get(36).replace("Closed", ""));
				
				if("0".equals(listCount.get(36)))
					request.put("CompClose10", " ");
				else
					request.put("CompClose10", listCount.get(36));
				
				
				if("0".equals(listCount.get(37)))
					request.put("CompPending10"," ");
				else
					request.put("CompPending10", listCount.get(37));
				
				if("0".equals(listCount.get(38)))
					request.put("CompRejected10", " ");
				else
					request.put("CompRejected10", listCount.get(38));
					
				if("0".equals(listCount.get(39)))
					request.put("CompResolved10", " ");
				else
					request.put("CompResolved10", listCount.get(39));
			}
