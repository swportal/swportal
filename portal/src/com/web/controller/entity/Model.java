...
public class Model implements java.io.Serializable{	
	...
	private String pRA;
	private String sRA;
	private String pLMTotal;
	private String pLMOpened;
	private String pLMResolved;
	private String pLMClosed;
	...
	public String getpLMTotal() {
		return pLMTotal;
	}
	public void setpLMTotal(String pLMTotal) {
		this.pLMTotal = pLMTotal;
	}
	public String getpLMOpened() {
		return pLMOpened;
	}
	public void setpLMOpened(String pLMOpened) {
		this.pLMOpened = pLMOpened;
	}
	public String getpLMResolved() {
		return pLMResolved;
	}
	public void setpLMResolved(String pLMResolved) {
		this.pLMResolved = pLMResolved;
	}
	public String getpLMClosed() {
		return pLMClosed;
	}
	public void setpLMClosed(String pLMClosed) {
