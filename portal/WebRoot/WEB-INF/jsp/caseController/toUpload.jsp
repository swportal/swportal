...
<html>
  ...
  <body>
	...
	<hr>
	   ...
	   <form id="fileForm" action="/portal/case/upload" method="post" enctype="multipart/form-data">
	    ...
	    <c:forEach var="file" items="${files}" varStatus = "var">  
	    	<table>
	    		<tr>
	    			<td width="400px">
	    				&nbsp;&nbsp;<a href="/portal/case/download/${file}">${file}</a> &nbsp;&nbsp;&nbsp;&nbsp;
	    			</td>
	    			<td width="200px">
	    				${times[var.index]}
	    			</td>
	    			<c:if test="${files.size()>0}">
		    			<td>
		    				<a href="/portal/case/delete/${file}?id=${id }">Delete</a>
		    			</td>
	    			</c:if>
	    		</tr>
	    	</table>
