			...
			function load(cur,flag,conflag,delflag,orderItem,orderKey){	
				...
				$.getJSON("/portal/case/findCaseList?keyword="+encodeURIComponent(keyword,"utf-8")+"&orderItem="+orderItem+"&orderKey="+orderKey+"&curpage="+cur+"&rn="+Math.random(),function(data){
					...
					$.each(data[0].caseList,function(i){	
			        	...
			        	strLeft+="<td bordercolor='#DEDEDE' width='70px' ><input type='text' "+disWord+" class='t'   id='prodType'   style='font-size:12px; color:"+fontColor+";  text-align:center;width:70px'  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].prodType.replace(new RegExp(/(')/g),'&#39;')+"'> </td>";
			        	strLeft+="<td bordercolor='#DEDEDE' width='70px' ><input type='text' "+disWord+" class='t'   id='chipset'  title="+data[0].caseList[i].chipset.replace(new RegExp(/(')/g),'&#39;')+" style='font-size:12px; color:"+fontColor+";  text-align:center;width:70px'  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].chipset.replace(new RegExp(/(')/g),'&#39;')+"'> </td>";
			        	strLeft+="<td  bordercolor='#DEDEDE' width='110px'  title='"+data[0].caseList[i].model.replace(new RegExp(/(')/g),'&#39;')+"'><input type='text' "+disWord+" class='t'   id='model'   style='font-size:12px; color:"+fontColor+";  text-align:center;width:110px'  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].model.replace(new RegExp(/(')/g),'&#39;')+"'> </td>";
			        	strLeft+="<td bordercolor='#DEDEDE' width='400px'  height='50px'><div title='"+data[0].caseList[i].description.replace(new RegExp(/(')/g),'&#39;')+"'><textarea rows='2'  "+disWord+" class='txt'   id='description'   style='font-size:12px; color:"+fontColor+";  text-align:left; width:100% '  onChange='updateCase(this,"+data[0].caseList[i].id+")' >"+data[0].caseList[i].description+" </textarea></div></td>";
			        	strLeft+="</tr>"; 
		        		
						strRight+="<tr bgcolor='#FFFFFF' bordercolor='#DEDEDE'>";
						strRight+="<td bordercolor='#DEDEDE' width='90px'  height='50px'><input type='text' "+disWord+" class='t'   id='occurTime'   style='font-size:12px; color:"+fontColor+";  text-align:center;width:100% '  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].occurTime.replace(new RegExp(/(')/g),'&#39;')+"'> </td>";
						strRight+="<td bordercolor='#DEDEDE' width='90px'><input type='text' "+disWord+" class='t'   id='occurSite' title='"+data[0].caseList[i].occurSite.replace(new RegExp(/(')/g),'&#39;')+"'  style='font-size:12px; color:"+fontColor+";  text-align:center;width:100% '  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].occurSite.replace(new RegExp(/(')/g),'&#39;')+"'> </td>";
						if(flag){
						 ...
						 strRight+="<td bordercolor='#DEDEDE' width='160px'><input type='text' "+disWord+" class='t'   id='version'   style=' word-wrap:break-word;word-break:break-all;font-size:12px; color:"+fontColor+";  text-align:center;width:100% '  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].version.replace(new RegExp(/(')/g),'&#39;')+"'> </td>";
						 strRight+="<td bordercolor='#DEDEDE' width='400px'  ><div title='"+data[0].caseList[i].rootReason.replace(new RegExp(/(')/g),'&#39;')+"'><textarea rows='2'  "+disWord+" class='txt'   id='rootReason'   style='font-size:12px; color:"+fontColor+";  text-align:left;width:100%  '  onChange='updateCase(this,"+data[0].caseList[i].id+")' >"+data[0].caseList[i].rootReason.replace(new RegExp(/(')/g),'&#39;')+" </textarea></div></td>";
						 strRight+="<td bordercolor='#DEDEDE' width='400px'  ><div title='"+data[0].caseList[i].unknownReason.replace(new RegExp(/(')/g),'&#39;')+"'><textarea rows='2'  "+disWord+" class='txt'   id='unknownReason'   style='font-size:12px; color:"+fontColor+";  text-align:left;width:100%  '  onChange='updateCase(this,"+data[0].caseList[i].id+")' >"+data[0].caseList[i].unknownReason+" </textarea></div></td>";
						 strRight+="<td bordercolor='#DEDEDE' width='300px'  ><div title='"+data[0].caseList[i].measureDev.replace(new RegExp(/(')/g),'&#39;')+"'><textarea rows='2'  "+disWord+" class='txt'   id='measureDev'   style='font-size:12px; color:"+fontColor+";  text-align:left;width:100%  '  onChange='updateCase(this,"+data[0].caseList[i].id+")' >"+data[0].caseList[i].measureDev+" </textarea></div></td>";
						 strRight+="<td bordercolor='#DEDEDE' width='300px'  ><div title='"+data[0].caseList[i].measureTest.replace(new RegExp(/(')/g),'&#39;')+"'><textarea rows='2'  "+disWord+" class='txt'   id='measureTest'   style='font-size:12px; color:"+fontColor+";  text-align:left;width:100% '  onChange='updateCase(this,"+data[0].caseList[i].id+")' >"+data[0].caseList[i].measureTest+" </textarea></div></td>";
						 if(flag){
						 ...
						 strRight+="<td bordercolor='#DEDEDE' width='80px'><div title='"+data[0].caseList[i].personINCharge.replace(new RegExp(/(')/g),'&#39;')+"'> <input type='text' "+disWord+" class='t'   id='personINCharge'  style='font-size:12px; color:"+fontColor+";  text-align:center;width:100% '  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].personINCharge.replace(new RegExp(/(')/g),'&#39;')+"'> </div></td>";
						 strRight+="<td bordercolor='#DEDEDE' width='80px'><input type='text' "+disWord+" class='t'   id='propagation'   style='font-size:12px; color:"+fontColor+";  text-align:center;width:100% '  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].propagation.replace(new RegExp(/(')/g),'&#39;')+"'> </td>";
						 strRight+="<td bordercolor='#DEDEDE' width='80px'><input type='text' "+disWord+" class='t'   id='gmapRegister'   style='font-size:12px; color:"+fontColor+";  text-align:center;width:100% '  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].gmapRegister.replace(new RegExp(/(')/g),'&#39;')+"'> </td>";
						 if(flag){
						 ...
						 strRight+="<td bordercolor='#DEDEDE' width='80px'><input type='text' "+disWord+" class='t'   id='checklistUpdate'   style='font-size:12px; color:"+fontColor+";  text-align:center;width:100% '  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].checklistUpdate.replace(new RegExp(/(')/g),'&#39;')+"'> </td>";
						 strRight+="<td bordercolor='#DEDEDE' width='80px'><input type='text' "+disWord+" class='t'   id='tcUpdate'   style='font-size:12px; color:"+fontColor+";  text-align:center;width:100% '  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].tcUpdate.replace(new RegExp(/(')/g),'&#39;')+"'> </td>";
						 strRight+="<td bordercolor='#DEDEDE' width='80px'><input type='text' "+disWord+" class='t'   id='plmRegister'   style='font-size:12px; color:"+fontColor+";  text-align:center;width:100% '  onChange='updateCase(this,"+data[0].caseList[i].id+")'  value='"+data[0].caseList[i].plmRegister.replace(new RegExp(/(')/g),'&#39;')+"'> </td>";
					...
					if(curpage < totalpage){
						nextpagehtml = "<a onclick='load("+(curpage+1)+",\""+flag+"\",\""+conflag+"\",\""+delflag+"\",\""+orderItem+"\",\""+orderKey+"\");' href='javascript:void(0);' href='javascript:void(0);'><font color='#3498db'>></font></a>&nbsp;&nbsp;&nbsp;";
