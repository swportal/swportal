...
<%--			  function getUrl(){--%>
<%--				  $.getJSON("/portal/edu/getUrl?rn="+Math.random(),function(data){	 --%>
...
<%--			  }--%>
		  ...
		  <script type="text/javascript">
		   function load(cur,flag,orderItem,orderKey){	
			 // alert(curpage);
			  pn=cur;
			  orderitm=orderItem;
			  orderk=orderKey;
						...
						$.each(data[0].eduList,function(i){
						  ...
						  var firstpagehtml; 
							...
							if((curpage-0)<=1){
								...
								firstpagehtml="<a onclick='load(1"+",\""+flag+"\",\""+orderItem+"\",\""+orderKey+"\");' href='javascript:void(0);'><font color='#3498db'><<</font></a>&nbsp;&nbsp;&nbsp;";
								prevpagehtml = "<a onclick='load("+(curpage-1)+",\""+flag+"\",\""+orderItem+"\",\""+orderKey+"\");' href='javascript:void(0);'><</a>";
							}
							if(curpage < totalpage){
								nextpagehtml = "<a onclick='load("+(curpage+1)+",\""+flag+"\",\""+orderItem+"\",\""+orderKey+"\");' href='javascript:void(0);' href='javascript:void(0);'>></a>&nbsp;&nbsp;&nbsp;";
								lastpagehtml="<a onclick='load("+(totalpage)+",\""+flag+"\",\""+orderItem+"\",\""+orderKey+"\");' href='javascript:void(0);'><font color='#3498db'>>></font></a> ";
							}else{
								nextpagehtml = "<a>></a>&nbsp;&nbsp;&nbsp;";
								lastpagehtml = "<a>>></a>";
							}
  	...
  	<body onload="load(1,'${usersession.hasPrivilegeByName('Training Update')}','id','DESC')">
  	...
  	<div id="navtop" >
		<ul class="navtop-skin">
				<li>
					...
					<input type="text" placeholder="Search" name="selectitem" id="selectitem" title="Input Title;Trainer;Trainer/Trainee Department"  oninput="javascript:load(1,'${usersession.hasPrivilegeByName('Training Update')}','id','DESC')"  style="color:#95a5a6; padding-left:5px;border-radius:5px;  width:160px; height:30px; vertical-align:middle;">	
	        	</li>
	       		 <li>
	...
	<div id="footer">
				...
				<a id="firstPage"   href="javascript:load(1,'${usersession.hasPrivilegeByName('Training Update')}','id','DESC');" style="text-decoration:none;"> << </a>&nbsp;
				<c:choose> 
				     <c:when test="curpage<=1">
				     	  <a> < </a>&nbsp;
				    </c:when> 
				    <c:otherwise>  
				    		<a id="prev" href="javascript:load((curpage-1),'${usersession.hasPrivilegeByName('Training Update')}','id','DESC');" style="text-decoration:none;"> < </a>&nbsp;
				    </c:otherwise>
				</c:choose> 
					<span class="current-page"></span>&nbsp;/&nbsp;<span class="page-num"></span>&nbsp;&nbsp;
				<c:choose> 
				    <c:when test="totalpage==curpage">
				    	<a> > </a>&nbsp; 
				    </c:when> 
				    <c:otherwise>  
				    		<a id="next" href="javascript:load((curpage+1),'${usersession.hasPrivilegeByName('Training Update')}','id','DESC');" style="text-decoration:none;"> > </a>&nbsp;
				    </c:otherwise>
				</c:choose>  
				
				<a id="lastPage" href="javascript:load(totalpage,'${usersession.hasPrivilegeByName('Training Update')}','id','DESC');" style="text-decoration:none;"> >> </a>
