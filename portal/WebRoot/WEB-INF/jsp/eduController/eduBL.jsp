...
<html>
	<head>
		...
		var total = 0;
		$(function(){   
				$.getJSON("/portal/edu/getCategory?rn="+Math.random(),function(jsondata){
					var data = [
					        	{name : 'Tech.',value : jsondata[0].techCount,color:'#a5c2d5'},
					        	{name : 'Proc.',value : jsondata[0].procCount,color:'#a56f8f'},
					        	{name : 'Tool',value : jsondata[0].toolCount,color:'#76a871'}
				        	];
					
					var chart = new iChart.Pie2D({
						title : {
							text:'Trainning Category('+jsondata[0].total+')',
							fontsize:12,
							color:'#333333',
						},
						offset_angle:-120,
